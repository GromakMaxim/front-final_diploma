            ...
            <section className="verification verification-passengers">
                ...
                <div className="verification-passengers-main">
                    <ul className="verification-passengers-list">
                        <PassengerSmall gender='Мужской' name='name' surname='surname' patronymic='patro'
                                        personType='Взрослый' birth='2022-07-19' document='3534 345345'/>
                        <PassengerSmall gender='Мужской' name='name1' surname='surname1' patronymic='patro1'
                                        personType='Взрослый' birth='2022-07-19' document='3534 345345'/>
                    </ul>
